...
| 阶段 | 范围 | 版本区间 | 状态 |
| --- | --- | --- | --- |
| 阶段 0 | 技术基础：TS 迁移、Zod 契约、ESLint/Prettier、Vitest 单测 | v0.0.2 ~ v0.0.8 | 🚧 进行中 |
...
- **目标**：文档链完整，阶段 0 验收
- **范围**：README 技术栈/脚本更新；CHANGELOG 汇总；打 `v0.0.8` 验收标签
